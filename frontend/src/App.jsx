...
function App() {
  ...
  // - content : texte a afficher dans la bulle
  ...
  // Petit etat de chargement pour desactiver le bouton pendant l'appel API.
  const [isLoading, setIsLoading] = useState(false);

  const sendMessage = async () => {
    const trimmedMessage = message.trim();

    // On evite d'envoyer des messages vides.
    ...
    // On affiche immediatement le message utilisateur.
    ...
    try {
      ...
      // On ajoute la reponse du bot dans l'historique.
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
      ...
      // Message de secours si le backend ne repond pas correctement.
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
  ...
  // Permet d'envoyer avec la touche Entree.
    ...
    <div className="min-h-screen bg-zinc-50 px-4 py-8">
      <div className="mx-auto flex max-w-4xl flex-col gap-4">
        ...
        <div className="flex h-[70vh] flex-col overflow-hidden rounded-lg border border-zinc-200 bg-white shadow-sm">
            ...
            {messages.map((msg, index) => (
              ...
              >
                ...
                >
                  ...
                  {/* On n'affiche ces infos que pour les messages du bot
          ...
          {/* Zone de saisie en bas de l'ecran */}
